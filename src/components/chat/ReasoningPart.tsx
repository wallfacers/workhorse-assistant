...
export default function ReasoningPart({
  ...
  return (
    <div data-component="reasoning-part" className="mb-2 flex flex-col gap-1.5">
      ...
      {open && (
        <div className="rounded-lg border border-outline/60 dark:border-neutral-800/60 bg-surface-muted/60 dark:bg-surface-dark/60 px-3 py-2 text-[12px] leading-relaxed text-gray-600 dark:text-gray-400">
          {redacted ? (
