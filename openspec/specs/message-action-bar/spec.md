# message-action-bar Specification

## Purpose
Provides copy, like, and dislike action buttons on assistant chat messages with visual confirmation feedback and structured feedback data output.
